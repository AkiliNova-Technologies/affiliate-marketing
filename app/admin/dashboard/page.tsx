...
const SalesByCategory = dynamic(
  ...
  {
    ssr: false,
    loading: () => <ChartSkeleton className="h-full min-h-[260px]" />,
  },
);
...
const productApprovalData: ProductApprovalRow[] = [
  {
    id: 1,
    vendor: "Maharia Library",
    product: "The Life of Amin",
    status: "Pending activation",
  },
  {
    id: 2,
    vendor: "Poa Safaris",
    product: "Trip to Kigezi",
    status: "Pending re-approval",
  },
  {
    id: 3,
    vendor: "World of Africa",
    product: "Cow Hide Shoes",
    status: "Pending activation",
  },
  {
    id: 4,
    vendor: "Lucy's Decor",
    product: "Out door event",
    status: "Pending activation",
  },
  {
    id: 5,
    vendor: "Tek Technologies",
      ...
      <SidebarInset>
        ...
        <div className="flex flex-1 flex-col gap-8 p-4 lg:p-6 bg-[#F7F7F7]">
          ...
          <h1 className="text-2xl font-bold text-foreground">
            Hi {user?.firstName || "there"}, here&apos;s how the system looks
            today
          </h1>
          ...
          <div className="grid grid-cols-1 gap-8 lg:grid-cols-[1fr_320px]">
            ...
            <div className="rounded-xl">
              <DataTable
                ...
                description="A list of products pending approval and reapproval"
                headerAction={
                   <Button
                  variant="outline"
                  size="sm"
          ...
          <div className="grid grid-cols-1 gap-8 lg:grid-cols-2">
            ...
            <div className="rounded-xl">
              <DataTable
                ...
                description="All Marketer Campaigns within the system"
                headerAction={
                  <Button
                    variant="outline"
                    size="sm"
